  ...
  return (
    <div className="space-y-6">
      <section className="rounded-xl border border-border bg-panel p-6 shadow-glow">
        <h2 className="text-2xl font-semibold text-textMain">AxisX Industrial Manufacturing Intelligence Engine</h2>
        <p className="mt-2 text-sm text-textSub">
          Autonomous multi-agent command layer for factory component planning under volatility.
        </p>
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          <div className="rounded-md border border-blue-500/25 bg-panel2 px-3 py-2">
            ...
            <p className="mt-1 text-sm font-semibold">5-Agent Manufacturing Mesh</p>
          </div>
          ...
          <div className="rounded-md border border-emerald-500/25 bg-panel2 px-3 py-2">
            ...
            <p className="mt-1 text-sm font-semibold">FastAPI + Live Factory Stream</p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-xl border border-border bg-panel p-5 shadow-glow">
        <h3 className="text-sm font-semibold uppercase tracking-[0.14em] text-textSub">Current Factory State</h3>
        <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <MetricCard label="Component Demand" value={`${Math.round(companyState.product_demand * 100)}%`} />
